...
class OrderModelSpec extends Specification {
    ...
    void "insert, then query"() {
        ...
        expect: "orders by user work"
            ...
            model.findOrdersForUser(3, Order.Status.active, Currency.ltc, Currency.mxn).empty
            model.findOrdersForUser(3, Order.Status.complete, Currency.eth, Currency.mxn).empty
